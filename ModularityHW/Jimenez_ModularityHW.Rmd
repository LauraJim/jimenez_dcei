...
map('state', fill = F)
  title("Temperature")
  # positive trends
  points(temp.sts[which(tscores==1),],pch=20,col="blue")
  # no trends
  points(temp.sts[which(tscores==0),],pch=20,col="yellow")
  # negative trends
  points(temp.sts[which(tscores==-1),],pch=20,col="red")
...
map('state', fill = F, region=c("alabama","ohio","tennessee"))
  title("Precipitation")
  # positive trends
  points(prec.sts[which(pscores==1),],pch=19,col="blue")
  # no trends
  points(prec.sts[which(pscores==0),],pch=19,col="yellow")
  # negative trends
  points(prec.sts[which(pscores==-1),],pch=19,col="red")
```
